...
from .views import home,arrendar, agregarprod,listarprod,modificar,eliminar, login, registro, arreglar, modificarUser
...
urlpatterns = [
    ...
    path('modificaruser/<username>/',modificarUser,name="modificaruser")
]
